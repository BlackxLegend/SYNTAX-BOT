...
(async () => {
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`https://github.com/jarif098/SYNTAX-BOT/raw/main/${filePath}`, {
	...
	const { data: packageHTML5 } = await axios.get("https://github.com/jarif098/SYNTAX-BOT/blob/main/package.json");
